namespace Be.Vlaanderen.Basisregisters.Projector.Internal.Runners
{
    ...
    internal class StreamStoreConnectedProjectionsSubscriptionRunner : IConnectedProjectionsSubscriptionRunner
    {
    ...
    internal class KafkaConnectedProjectionsSubscriptionRunner : IConnectedProjectionsSubscriptionRunner
    {
